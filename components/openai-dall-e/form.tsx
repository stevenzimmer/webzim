...
export default function Form() {
  ...
  <>
    <form className="our-form my-12" onSubmit={handleSubmit}>
          ...
          <button disabled={isLoading} className=" bg-indigo-200 rounded px-3 py-2 disabled:bg-slate-200 disabled:cursor-not-allowed disabled:text-slate-400">Generate image</button>
        </form>
        ...
        {isLoading && (
          <div>
            <svg className="animate-spin h-10 w-10 text-slate-200 mx-auto mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
